module MobileConfig
  class MdmByod < Data.define(:uuid, :identity_cerificate, :topic, :assigned_managed_apple_id)
    ...
    def server_url
      "#{ENV['MDM_SERVER_BASE_URL']}/mdm-byod/command"
    end

    def check_in_url
      "#{ENV['MDM_SERVER_BASE_URL']}/mdm-byod/checkin"
    end
